...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            SnapLib<NodeImpl,Message> snaplib = new SnapLib(registry, self.getInConn(), self.getOutConn(), self);
            ...
            for (Connection c : self.getOutConn()) {
                ...
                self.nodeB = (PublicInt) LocateRegistry
            ...
            // MINI TEST SNAPSHOT
            Snapshot<NodeImpl, Message> snapshot = new Snapshot("snap1", self);
